...
from app.modules.notice.forms import NoticeForm
from . import notice as noticeRoute
...
# 通知查询
@noticeRoute.route('/noticelist', methods=['GET', 'POST'])
@login_required
def noticelist():
    return common_list(notice, 'noticelist.html')


# 通知配置
@noticeRoute.route('/noticeedit', methods=['GET', 'POST'])
@login_required
def noticeedit():
    return common_edit(notice, NoticeForm(), 'noticeedit.html')
