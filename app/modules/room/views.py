...
from app.modules.room.forms import RoomForm
from . import room
...
# 通知方式查询
@room.route('/roomlist', methods=['GET', 'POST'])
@login_required
def roomlist():
    return common_list(roommodel, 'roomlist.html')


# 通知方式配置
@room.route('/roomedit', methods=['GET', 'POST'])
@login_required
def roomedit():
    return common_edit(roommodel, RoomForm(), 'roomedit.html')
