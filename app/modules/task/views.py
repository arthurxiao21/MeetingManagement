...
from app.modules.task.forms import TaskForm
from . import task
...
# 通知方式查询
@task.route('/tasklist', methods=['GET', 'POST'])
@login_required
def tasklist():
    return common_list(taskmodel, 'tasklist.html')


# 通知方式配置
@task.route('/taskedit', methods=['GET', 'POST'])
@login_required
def taskedit():
    return common_edit(taskmodel, TaskForm(), 'taskedit.html')
